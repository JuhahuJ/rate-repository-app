...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      const selectedOrdering = { orderBy: 'CREATED_AT', orderDirection: 'DESC' }
      const setSelectedOrdering = jest.fn()
      ...
      expect(firstRepositoryItem).toBeTruthy()
      ...
      expect(secondRepositoryItem).toBeTruthy()
